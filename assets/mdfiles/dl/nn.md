...
　　参数：output-输出input-神经元输入 sigmoid-一个S形函数，原型：
...
　　我们想象，如果左边输入的是一个图像的像素数组，大家都知道像素是０－２５５的数字。假如我们有一个<p align="center"><img src="https://latex.codecogs.com/gif.latex?100*100"/></p>  
的图像，我们定义一个 <p align="center"><img src="https://latex.codecogs.com/gif.latex?10000*1000*100*2"/></p>
